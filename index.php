                                    ...
                                    <div class="col-lg-1-5 col-md-4 col-12 col-sm-6">
                                        <div class="product-cart-wrap mb-30">
                                            ...
                                            <div class="product-content-wrap">
                                                ...
                                                <h2><a href="shop-product-right.html"><?php echo $productData->description; ?></a></h2>
                    ...
                    <div class="sidebar-widget widget-category-2 mb-30">
                        ...
                        <ul>
                            ...
                            foreach ($categoryItemData as $categoryValue) {
                                ?>
                                    <li>
                                        <a href="shop-grid-right.html"> <img src="assets/imgs/theme/icons/category-1.svg" alt="" /><?php echo $categoryValue->categoryName; ?></a><span class="count"><?php echo $categoryValue->item; ?></span>
                                    </li>
                                   <?php
                            }
                            ?>
