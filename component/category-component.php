...
<div class="sidebar-widget widget-category-2 mb-30">
    ...
    <ul>
        ...
        ?>
            <li>
                <a href="shop-grid-right.php?category_id=<?php echo $categoryValue->categoryID; ?>"> <img src="//metroapi/<?php echo $categoryValue->categoryImg; ?>" alt="" /><?php echo $categoryValue->categoryName; ?></a><span class="count"><?php echo $categoryValue->item; ?></span>
            </li>
        <?php
        }
        ?>
