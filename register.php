                                    ...
                                    <div class="padding_eight_all bg-white">
                                        ...
                                        <!-- <form method="post"> -->
                                            ...
                                            <div class="login_footer form-group mb-50">
                                                <div class="chek-form">
                                                    <div class="custome-checkbox">
                                                        <input class="form-check-input" type="checkbox" name="checkbox" id="agreeBtn" value="" />
                                            ...
                                            <div class="form-group mb-30">
                                                <button type="submit" class="btn btn-fill-out btn-block hover-up font-weight-bold" name="login" onclick="userRegister()">Submit &amp; Register</button>
                                            </div>
