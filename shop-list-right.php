                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 col-sm-12 col-xs-12">
                            <div class="detail-info pr-30 pl-30">
                                ...
                                <h3 class="title-detail"><a href="product.php" class="text-heading">Seeds of Change Organic Quinoa, Brown</a></h3>
                                        ...
                                        <ul>
                                            <li>
                                                <div class="shopping-cart-img">
                                                    <a href="product.php"><img alt="Nest" src="assets/imgs/shop/thumbnail-3.jpg" /></a>
                                                </div>
                                                <div class="shopping-cart-title">
                                                    <h4><a href="product.php">Daisy Casual Bag</a></h4>
                                            ...
                                            <li>
                                                <div class="shopping-cart-img">
                                                    <a href="product.php"><img alt="Nest" src="assets/imgs/shop/thumbnail-2.jpg" /></a>
                                                </div>
                                                <div class="shopping-cart-title">
                                                    <h4><a href="product.php">Corduroy Shirts</a></h4>
                ...
                <div class="header-wrap header-space-between position-relative">
                    ...
                    <div class="header-nav d-none d-lg-flex">
                        <div class="main-categori-wrap d-none d-lg-block">
                            ...
                            <div class="categories-dropdown-wrap categories-dropdown-active-large font-heading">
                                <div class="d-flex categori-dropdown-inner">
                                    <ul>
                                        <li>
                                            <a href="products.php"> <img src="assets/imgs/theme/icons/category-1.svg" alt="" />Milks and Dairies</a>
                                        </li>
                                        <li>
                                            <a href="products.php"> <img src="assets/imgs/theme/icons/category-2.svg" alt="" />Clothing & beauty</a>
                                        </li>
                                        <li>
                                            <a href="products.php"> <img src="assets/imgs/theme/icons/category-3.svg" alt="" />Pet Foods & Toy</a>
                                        </li>
                                        <li>
                                            <a href="products.php"> <img src="assets/imgs/theme/icons/category-4.svg" alt="" />Baking material</a>
                                        </li>
                                        <li>
                                            <a href="products.php"> <img src="assets/imgs/theme/icons/category-5.svg" alt="" />Fresh Fruit</a>
                                        </li>
                                    </ul>
                                    <ul class="end">
                                        <li>
                                            <a href="products.php"> <img src="assets/imgs/theme/icons/category-6.svg" alt="" />Wines & Drinks</a>
                                        </li>
                                        <li>
                                            <a href="products.php"> <img src="assets/imgs/theme/icons/category-7.svg" alt="" />Fresh Seafood</a>
                                        </li>
                                        <li>
                                            <a href="products.php"> <img src="assets/imgs/theme/icons/category-8.svg" alt="" />Fast food</a>
                                        </li>
                                        <li>
                                            <a href="products.php"> <img src="assets/imgs/theme/icons/category-9.svg" alt="" />Vegetables</a>
                                        </li>
                                        <li>
                                            <a href="products.php"> <img src="assets/imgs/theme/icons/category-10.svg" alt="" />Bread and Juice</a>
                                        </li>
                                    </ul>
                                </div>
                        ...
                        <div class="main-menu main-menu-padding-1 main-menu-lh-2 d-none d-lg-block font-heading">
                            <nav>
                                <ul>
                                    <li class="hot-deals"><img src="assets/imgs/theme/icons/icon-hot.svg" alt="hot deals" /><a href="products.php">Deals</a></li>
                                    <li>
                                        ...
                                        <ul class="mega-menu">
                                            <li class="sub-mega-menu sub-mega-menu-width-22">
                                                ...
                                                <ul>
                                                    ...
                                                    <li><a href="product.php">Exotic Fruits & Veggies</a></li>
                                ...
                                <div class="cart-dropdown-wrap cart-dropdown-hm2">
                                    <ul>
                                        <li>
                                            ...
                                            <div class="shopping-cart-title">
                                                <h4><a href="product.php">Plain Striola Shirts</a></h4>
                                        ...
                                        <li>
                                            <div class="shopping-cart-img">
                                                <a href="product.php"><img alt="Nest" src="assets/imgs/shop/thumbnail-4.jpg" /></a>
                                            </div>
                                            <div class="shopping-cart-title">
                                                <h4><a href="product.php">Macbook Pro 2022</a></h4>
            ...
            <div class="row">
                    ...
                    <div class="product-list mb-50">
                        <div class="product-cart-wrap">
                            ...
                            <div class="product-content-wrap">
                                <div class="product-category">
                                    <a href="products.php">Hodo Foods</a>
                                </div>
                                <h2><a href="product.php">Field Roast Chao Cheese Creamy Original</a></h2>
                                ...
                                <div class="mt-30 d-flex align-items-center">
                                    <a aria-label="Buy now" class="btn" href="shop-cart.php"><i class="fi-rs-shopping-cart mr-5"></i>Add to Cart</a>
                        ...
                        <div class="product-cart-wrap">
                            ...
                            <div class="product-content-wrap">
                                ...
                                <h2><a href="product.php">Fresh Organic Mustard Leaves</a></h2>
                                <div class="product-rate-cover">
                                    <div class="product-rate d-inline-block">
                                        <div class="product-rating" style="width: 90%"></div>
                                    </div>
                        ...
                        <div class="product-cart-wrap">
                            ...
                            <div class="product-content-wrap">
                                ...
                                <h2><a href="product.php">Organic Green Bell Pepper</a></h2>
                                <div class="product-rate-cover">
                                    <div class="product-rate d-inline-block">
                                        <div class="product-rating" style="width: 90%"></div>
                                    </div>
                        ...
                        <div class="product-cart-wrap">
                            ...
                            <div class="product-content-wrap">
                                ...
                                <h2><a href="product.php">Angie’s Boomchickapop Sweet & Salty Kettle Corn</a></h2>
                                <div class="product-rate-cover">
                                    <div class="product-rate d-inline-block">
                                        <div class="product-rating" style="width: 90%"></div>
                                    </div>
                        ...
                        <div class="product-cart-wrap">
                            ...
                            <div class="product-content-wrap">
                                ...
                                <h2><a href="product.php">Foster Farms Takeout Crispy Classic Buffalo Wings</a></h2>
                                <div class="product-rate-cover">
                                    <div class="product-rate d-inline-block">
                                        <div class="product-rating" style="width: 90%"></div>
                                    </div>
                                ...
                                <div class="product-cart-wrap style-2">
                                    ...
                                    <div class="product-content-wrap">
                                        ...
                                        <div class="deals-content">
                                            <h2><a href="product.php">Seeds of Change Organic Quinoa, Brown</a></h2>
                                            <div class="product-rate-cover">
                                                <div class="product-rate d-inline-block">
                                                    <div class="product-rating" style="width: 90%"></div>
                                                </div>
                            ...
                            <div class="col-xl-3 col-lg-4 col-md-6">
                                <div class="product-cart-wrap style-2">
                                    ...
                                    <div class="product-content-wrap">
                                        ...
                                        <div class="deals-content">
                                            <h2><a href="product.php">Perdue Simply Smart Organics Gluten</a></h2>
                                            <div class="product-rate-cover">
                                                <div class="product-rate d-inline-block">
                                                    <div class="product-rating" style="width: 90%"></div>
                                                </div>
                            ...
                            <div class="col-xl-3 col-lg-4 col-md-6 d-none d-xl-block">
                                <div class="product-cart-wrap style-2">
                                    ...
                                    <div class="product-content-wrap">
                                        ...
                                        <div class="deals-content">
                                            <h2><a href="product.php">Simply Lemonade with Raspberry Juice</a></h2>
                                            <div class="product-rate-cover">
                                                <div class="product-rate d-inline-block">
                                                    <div class="product-rating" style="width: 80%"></div>
                                                </div>
                ...
                <div class="col-lg-1-5 primary-sidebar sticky-sidebar">
                    <div class="sidebar-widget widget-category-2 mb-30">
                        ...
                        <ul>
                            <li>
                                <a href="products.php"> <img src="assets/imgs/theme/icons/category-1.svg" alt="" />Milks & Dairies</a><span class="count">30</span>
                            </li>
                            <li>
                                <a href="products.php"> <img src="assets/imgs/theme/icons/category-2.svg" alt="" />Clothing</a><span class="count">35</span>
                            </li>
                            <li>
                                <a href="products.php"> <img src="assets/imgs/theme/icons/category-3.svg" alt="" />Pet Foods </a><span class="count">42</span>
                            </li>
                            <li>
                                <a href="products.php"> <img src="assets/imgs/theme/icons/category-4.svg" alt="" />Baking material</a><span class="count">68</span>
                            </li>
                            <li>
                                <a href="products.php"> <img src="assets/imgs/theme/icons/category-5.svg" alt="" />Fresh Fruit</a><span class="count">87</span>
                            </li>
                        </ul>
                    </div>
                    <!-- Fillter By Price -->
                    <div class="sidebar-widget price_range range mb-30">
                        ...
                        <a href="products.php" class="btn btn-sm btn-default"><i class="fi-rs-filter mr-5"></i> Fillter</a>
                    </div>
