...
if (array_key_exists('phoneNumber', $_GET)) {
    ...
    try {
        ...
        $userInfo = new User(null, null, (isset($jsonData->fullName) ? trim($jsonData->fullName) : null), (isset($jsonData->emailAddress) ? trim($jsonData->emailAddress) : null), trim($jsonData->phoneNumber), (isset($jsonData->userAddress) ? trim($jsonData->userAddress) : null), null, null, null);
