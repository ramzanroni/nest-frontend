                                    ...
                                    <div class="padding_eight_all bg-white">
                                        ...
                                        <!-- <form method="post"> -->
                                            <div class="form-group">
                                                <input type="text" required="" id="email" name="email" placeholder="Username or Email *" />
                                            </div>
                                            <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                <button type="submit" class="btn btn-heading btn-block hover-up" name="login" onclick="userLogin()">Log in</button>
                                            </div>
                                        <!-- </form> -->
                                    </div>
                                </div>
